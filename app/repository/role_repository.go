...
// RoleRepository membaca pemetaan role -> permission dari database.
...
//
// LEFT JOIN, bukan INNER JOIN: role 'user' tidak punya permission apa pun.
// Dengan INNER JOIN ia hilang dari hasil, IsKnownRole("user") jadi false,
// dan admin tidak akan pernah bisa menurunkan siapa pun menjadi 'user'.
// COALESCE mengubah NULL hasil LEFT JOIN menjadi string kosong.
